      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            const Text(' PIC, USER', style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF005696))),
            const SizedBox(height: 30),
            const Text('Perfil de Trabajador', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 20),
            _buildInfoField('Código:', 'US122334'),
            _buildInfoField('Nombres:', 'User '),
            _buildInfoField('Apellidos:', 'Pic'),
            _buildInfoField('DNI:', '12345678'),
            _buildInfoField('Email:', 'userpic@gmail.com'),
          ],
        ),
      ),
    );
